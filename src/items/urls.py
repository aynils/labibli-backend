...
urlpatterns = [
    ...
    path(
        r"collections/<int:pk>/",
        views.CollectionDetail.as_view(),
        name="get_put_patch_delete_collection",
    ),
    path(
        r"collections/<str:slug>/",
        views.CollectionShared.as_view(),
        name="get_collection_shared",
    ),
    # Lendings
    path(
        r"lendings/<int:pk>/",
        views.LendingDetail.as_view(),
        name="get_put_patch_delete_lending",
    ),
    path(
        r"lendings/<int:pk>/return/",
        views.ReturnLending.as_view(),
        name="return_lending",
    ),
